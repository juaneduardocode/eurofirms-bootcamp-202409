...
function Homeaux(props) {
    console.log('Homeaux -> render')

    const [name, setName] = useState(null)
    const [infos, setInfos] = useState([])

    console.log('Homeaux -> state: name = ' + name)
    ...
    <footer className="bg-blue text-white fixed bottom-0 w-full flex justify-center items-center h-8">
        <div><button className="leading-3 rounded h-4 p-1 flex items-center" type="button" onClick={handleCreateInfoClick}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
