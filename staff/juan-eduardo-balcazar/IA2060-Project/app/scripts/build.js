// build.js
const configFactory = require('./config');  // Asegúrate de que la ruta sea correcta

const config = configFactory('production');
console.log(config);  // Solo para verificar que la configuración se cargue correctamente

// Aquí continúa el resto del código de tu script build.js
...
// 
// import fsExtra from 'fs-extra.js';
import fsExtra from 'fs-extra';
import bfj from 'bfj';
import webpack from 'webpack';
import * as webpackConfig from "../config/webpack.config.js";
